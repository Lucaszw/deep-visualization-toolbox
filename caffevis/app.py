...
class CaffeVisApp(BaseApp):
    ...
    def __init__(self, settings, key_bindings):
        ...
        print("OLD PATH:")
        print(sys.path)
        sys.path.insert(1, os.path.join(settings.caffevis_caffe_root, 'python'))
    ...
    def _draw_layer_pane(self, pane):
        ...
        if self.state.pattern_mode:
            ...
            print("JPGVIS caffevis_jpgvis_layers:")
            print(self.settings.caffevis_jpgvis_layers)
